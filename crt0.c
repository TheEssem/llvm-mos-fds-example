// This file has been modified from its original version preset in llvm-mos-sdk.
// Most notably, the reset routine now sets the FDS to use vertical mirroring and the FDS license bypass has been added.
